...
class TriviaPlayPage extends StatefulWidget {
  ...
  TriviaPlayPage({required this.trivia});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(icon: const Icon(Icons.check), onPressed: _finishTrivia)
          ],
        ),
        body: Padding(
    ...
    if (selectedAnswers.length == widget.trivia.questions.length) {
      ...
      showDialog(
          ...
          builder: (context) {
            return AlertDialog(
              content:
                  const Text('You must answer all questions to finish trivia'),
              actions: [
                TextButton(
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Correct answer is: ' + question.correctAnswer),
                        ],
                      ),
                    );
                  }),
